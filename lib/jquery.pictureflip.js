...
this.$element.append('<div class="prev" onClick="prevStoryPage()"><img src="img/next_page_left.png" class="" style="height: 100%"></div><div class="next" onClick="nextStoryPage()"><img src="img/next_page_right.png" class="" style="height: 100%"></div>');
