            ...
            if (pageTo > storyPage) {
                ...
                switch (currentSlidePage) {
                    case 1:
                        ...
                        $("#divS2").find('.img').css(
                        {
                            'background-image': 'url(' + imageRootStorage + '/TheLibrary/' + storyCatGlobal + '/story' + currentStory + '/' + (storyPage + 1) + '.jpg)',
                            'background-size': '100% 0px'
                        });
                    ...
                    case 2:
                        $('#flipbook').attr('style', 'background:url(' + imageRootStorage + '/TheLibrary/' + storyCatGlobal + '/story' + currentStory + '/' + (storyPage + 1) + '.jpg)');
                        $("#divS2").find('.img').css(
                        {
                            'background-image': 'url(' + imageRootStorage + '/TheLibrary/' + storyCatGlobal + '/story' + currentStory + '/' + (storyPage) + '.jpg)',
                            'background-size': '100% 0px'
...
function storeInPhone(data, category, id) {
    ...
    var downloadStoryFiles = function (dataFromServer, storyCat, storyId, cb) {
        done_callback = cb;
        download_10(storyId, storyCat, done_callback);
    ...
    var loadComponents = function (storyId, storyCat, sounds, images) {
        ...
        var interval = setInterval(function () {
            if (localStorage.getItem('download_10') == 'true') {
                ...
                downloadRest(storyId, storyCat, sounds, images);
            }
        }, 1000);
...
function download_10(storyId, storyCat, cb) {
    alert('10');
    for (var i = 0; i < 10 ; i++) {
        var page = i + 1;
